...
const etiquetteData: EtiquetteQuestion[] = [
  ...
  {
    id: '1',
    question: 'What is the most common traditional greeting in Japan?',
    answer: 'The most common traditional greeting in Japan is a bow (お辞儀, ojigi), which signifies respect and humility.',
    culture: 'japan',
    category: 'greetings'
  },
  {
  ...
  {
    id: '1',
    question: 'When is a deep bow (Saikeirei) used?',
    answer: 'A deep bow is used in highly formal situations, such as apologizing, expressing deep gratitude, or addressing someone of high status.',
    culture: 'japan',
    category: 'greetings'
  },
  {
  ...
  {
    id: '2',
    question: 'What greeting is commonly used by Sikhs?',
    answer: 'Sikhs commonly greet each other with "Sat Sri Akal," which means "God is the eternal truth."',
    culture: 'india',
    category: 'greetings'
  },
  {
    id: '2',
    question: 'What is the traditional greeting in Tamil Nadu?',
    answer: 'In Tamil Nadu, people greet each other with "Vanakkam," accompanied by folded hands.',
    culture: 'india',
    category: 'greetings'
  },
  {
    id: '2',
    question: 'What is the traditional greeting used by Jains',
    answer: 'Jains commonly greet each other with "Jai Jinendra" which means "Victory to the Jinas (spiritual victors)."',
    culture: 'india',
    category: 'greetings'
  },
  {
